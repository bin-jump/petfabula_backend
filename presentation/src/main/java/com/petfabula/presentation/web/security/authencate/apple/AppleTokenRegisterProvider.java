...
@Component
public class AppleTokenRegisterProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        AppleRegisterToken token = (AppleRegisterToken)authentication;

        try {
            String name = (String)token.getPrincipal();
            String jwtToken = (String)token.getCredentials();

            UserAccount account = register(name, jwtToken);
    ...
    public boolean supports(Class<?> aClass) {
        return aClass.equals(AppleRegisterToken.class);
    }
